...
public class PhotoActivity extends Activity {
    ...
    private PhotoViewer mCordovaPlugin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 13/4/22 DH: Call 'CordovaPlugin.callbackContext' from here for propagation of which btn pressed
                // 14/4/22 DH: This leads to 'com.example.app.MainActivity cannot be cast to com.sarriaroman.PhotoViewer.PhotoActivity'
                //returnCallback();

                Log.d(LOG_TAG,"Activity.closeBtn.onClick()");
                //finish();

                // 14/4/22 DH: Getting around 'MainActivity cannot be cast to PhotoActivity'
                //finishActivity(PhotoViewer.SPEECH_CODE);
                getActivity().setResult(PhotoViewer.SPEECH_CODE);
                getActivity().finish();
            }
        });
    ...
    // --------------------------------------------------------------------------
    // 14/4/22 DH: This leads to 'com.example.app.MainActivity cannot be cast to com.sarriaroman.PhotoViewer.PhotoActivity'
    public void setCordovaPlugin(PhotoViewer cordovaPlugin) {
        this.mCordovaPlugin = cordovaPlugin;
    }

    public void returnCallback(){
        this.mCordovaPlugin.callbackContext.success("PhotoActivity callback");
    }
    // --------------------------------------------------------------------------
